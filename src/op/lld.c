...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/14 11:49:22 by del-alj           #+#    #+#             */
/*   Updated: 2021/01/14 11:50:41 by del-alj          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int	ft_get_argument_value_for_lld(t_process *process, int arg, \
...
void		ft_operation_lld(t_process *proc)
{
	...
	else
	{
		...
		{
			args[0] = ft_get_argument_value_for_lld(proc, args[0], \
						parameters[0]);
